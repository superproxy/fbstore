...
public class FastoreRedisServer implements RedisServer {
    ...
    private Object _get(byte[] key0) {
        ...
        commonRequest.setCommonHeader(supported);
        commonRequest.setBody(new String(key0));
        CommonResponse commonResponse = DefaultRequestHandlerChains.getInstance().handler(commonRequest);
        return commonResponse.getResponseBody().toString().getBytes();
    }
    ...
    /**
     * Authenticate to the faststore.dataserver.server
     * Connection
     *
     * @param password0
     * @return StatusReply
    ...
    /**
     * Ping the faststore.dataserver.server
     * Connection
     *
     * @return StatusReply
     */
    ...
    /**
     * Make the faststore.dataserver.server crash
     * Server
     *
     * @return Reply
     */
    ...
    /**
     * Get information and statistics about the faststore.dataserver.server
     * Server
     *
     * @return BulkReply
     */
    ...
    /**
     * Listen for all requests received by the faststore.dataserver.server in real time
     * Server
     *
     * @return Reply
     */
    ...
    /**
     * Synchronously save the dataset to disk and then shut down the faststore.dataserver.server
     * Server
     *
     * @param NOSAVE0
     * @param SAVE1
    ...
    /**
     * Make the faststore.dataserver.server a slave of another instance, or promote it as master
     * Server
     *
     * @param host0
     * @param port1
    ...
    /**
     * Return the current faststore.dataserver.server time
     * Server
     *
     * @return MultiBulkReply
     */
    ...
    /**
     * Execute a Lua script faststore.dataserver.server side
     * Scripting
     *
     * @param script0
     * @param numkeys1
